...
- Tableau 활용 KPI 대시보드 구축 및 인사이트 도출
...
- 대학생 커뮤니티 앱 **[KOIN](https://koreatech.in/)** 사용자 로그 기반 서비스 데이터 분석 (MAU 1,700+)
- 유저 세그먼트 및 리텐션 · 행동 패턴 분석을 통해 기능 개선 인사이트 도출
- 이벤트 로그 설계 및 검수 프로세스 참여
- A/B Test 설계 및 Tableau 기반 핵심 지표 대시보드 구축

...
- 개인화 추천 알고리즘 개선을 위한 A/B Test 설계 및 실험 지표 설정 (CTR, CVR, ARPU)
...
- 사용자 행동 로그를 활용한 유저 세그먼트 정의 및 행동 패턴 분석
- 서비스 기능 개선을 위한 이벤트 로그 설계 및 데이터 검수 프로세스 참여
- 리텐션 분석을 통한 사용자 이용 흐름 및 이탈 요인 도출
- Tableau 기반 핵심 지표 대시보드 구축 및 시각화
- A/B Test 실험 설계, 대상자 정의 및 통계적 유의성 검정 수행

---

### 🔹 알고리즘 소모임 씨앗 회장 (2026.03 ~ 현재)
- 주차별 알고리즘 커리큘럼 기획 및 강의 진행 (자료구조 / DP / 그래프 등)
- 백준 플랫폼 기반 문제 풀이 및 시간 복잡도 최적화 전략 교육

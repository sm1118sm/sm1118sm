...
* A/B Test 설계 및 핵심 지표 분석
* Tableau, Superset 기반 데이터 시각화 및 대시보드 구축
* 문제 해결을 위한 논리적 사고와 지속적인 학습 지향
...
- 대학알리미·대학 요람·학칙·전형계획을 기반으로 자율전공 제도 및 중도이탈 구조 분석
- 재학생 설문 72명과 학생 인터뷰를 통해 자율전공 학생의 주요 문제 검증
- A~E 5개 영역 42문항 기반 위험 진단 및 코호트별 문제 분석
- 규칙 기반 위험군 판정 및 임계값 민감도 분석
- 분석 결과를 바탕으로 전공 탐색·학업 부담·소속감·심리 부적응 등에 대한 정책 제안
- 대시보드를 구축하여 학생별 위험 영역 및 맞춤 정책 추천 결과 시각화
- **총 12팀 중 2위, 우수상 수상**
...
* Tableau 기반 핵심 지표 대시보드 구축
* 서비스 개선을 위한 데이터 기반 인사이트 도출

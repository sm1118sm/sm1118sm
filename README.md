...
- **이커머스 데이터 분석 프로젝트:** Funnel 분석을 통한 이탈 지점 파악 및 A/B Test 설계
- **머신러닝 & 통계:** 로지스틱 회귀 및 결정 나무를 활용한 사용자 행동 예측 모델 기초 구축
- **대시보드:** Tableau를 활용한 주요 비즈니스 KPI 시각화 및 자동화 보고서 제작
...
**🔹 1. BCSD Lab - 데이터 분석 트랙** (2026.01 ~ 현재)
- **[코인(KOIN)](https://koreatech.in/) 서비스 분석:** 실사용자(DAU 1,300+) 로그 기반 유저 세그먼트 분석
